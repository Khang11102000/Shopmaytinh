                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid">
                            ...
                            <div class="card mb-4">
                                <a class="card-header" href="/insert_brand.jsp">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form method="post" action="/Shopmaytinh/InsertProductServletx" enctype="multipart/form-data">
                                            ...
                                            <center>
                                                <a href="/update_brand.jsp?command=update&brand_id=<%=brand.getBrandID()%>">Sửa</a>&nbsp;&nbsp; | &nbsp;&nbsp;
                                                <a href="/ManagerBrandServlet?command=delete&brand_id=<%=brand.getBrandID()%>">Xóa</a>
                                            </center>
                                            </td>
                                            </tr>
                                            </tbody>
