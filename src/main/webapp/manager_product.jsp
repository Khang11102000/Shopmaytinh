                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid">
                            ...
                            <div class="card mb-4">
                                <a class="card-header" href="/insert_product.jsp">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form method="post" action="/InsertProductServletx" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="hinhql" style="width: 256px; height: 256px" src="<%=product.getProductImage()%>"/><!-- comment -->
                                                        
                                                    </td>

                                                    <td><%=formatter.format(product.getProductPrice())%></td>
                                                    <td><a href="/product_description.jsp?product_id=<%=product.getProductID()%>">Xem chi tiết</a></td>
                                                    <td>
                                            <center>
                                                <a href="/update_product.jsp?command=update&product_id=<%=product.getProductID()%>">Sửa</a>&nbsp;| &nbsp;
                                                <a href="/ManagerProductServlet?command=delete&product_id=<%=product.getProductID()%>">Xóa</a>
                                            </center>
                                            </td>
                                            </tr>
                                            </tbody>
